...
export default function Home() {
  return (
    <main className="min-h-screen w-full bg-zinc-100 text-zinc-950">
      <section className="w-full overflow-hidden bg-zinc-950 text-white">
        <div className="relative mx-auto grid w-full max-w-6xl items-center gap-10 px-6 py-16 sm:py-20 lg:min-h-[640px] lg:grid-cols-[minmax(0,1fr)_minmax(380px,520px)] lg:px-8 lg:py-20">
          <div className="max-w-3xl">
            ...
            <div className="mt-5 max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-8 text-zinc-200 sm:text-xl sm:leading-9">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link
                href="/dashboard"
                className="inline-flex h-14 items-center justify-center rounded-md bg-white px-7 text-base font-semibold text-zinc-950 shadow-sm transition-colors hover:bg-zinc-200"
              >
                ダッシュボードへ
              </Link>
              <Link
                href="/records/new"
                className="inline-flex h-14 items-center justify-center rounded-md border border-white/20 px-7 text-base font-semibold text-white transition-colors hover:bg-white/10"
              >
                記録を追加
              </Link>
              <Link
          ...
          <div className="w-full space-y-5">
            <div className="rounded-lg border border-white/15 bg-white/10 p-6 shadow-2xl">
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-14 sm:py-16 lg:px-8 lg:py-20">
        <div>
